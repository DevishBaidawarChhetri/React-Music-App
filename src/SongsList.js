...
function chillHopMusics () {
  ...
  return [
    ...
    },
    {
      ...
      audio: `${ base_url }the-reason-hoobastank.mp3`,
      color: [ '#8EB4E4', '#522B24' ],
      active: false
    },
    {
      id: uuid(),
      name: "through the fire and flames (live)",
      artist: "dragon force",
      cover: "https://upload.wikimedia.org/wikipedia/en/f/f6/Through_the_Fire_and_Flames_Cover_Art.jpg",
      audio: `${ base_url }through-the-fire-and-flames-live-dragon-force.mp3`,
      color: [ '#EDDAB0', '#DE9E67' ],
      active: false
    },
    {
      ...
      audio: `${ base_url }titanic-titanic-movie.mp3`,
      color: [ '#E8906E', '#444194' ],
      active: false
    },
    {
    ...
    },
    {
      ...
      audio: `${ base_url }the-death-of-love-cradle-of-filth.mp3`,
      color: [ '#7E7A54', '#FFC67C' ],
      active: false
    },
    {
