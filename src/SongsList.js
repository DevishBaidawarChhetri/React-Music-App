...
function chillHopMusics() {
  const base_url = "https://resonant-indigo-fels3n3jwv.edgeone.app/"; // edgeone.ai.d1@gmail.com
  const base_url_1 = "https://resonant-indigo-fels3n3jwv.edgeone.app/";
  return [
    {
      id: uuid(),
      name: "love somebody",
    ...
    },
    {
      ...
      artist: "Maroon 5",
      cover:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCG0CZClJYpfPMYT-Xfj_A-ftMisC8IUDc2w&usqp=CAU",
    ...
    },
    {
      ...
      artist: "green day",
      cover:
        "https://cdns-images.dzcdn.net/images/cover/ebd6fc49c3c87cbd5441424f151c04f2/350x350.jpg",
    ...
    //   artist: "green day",
    //   cover:
    //     "https://images-na.ssl-images-amazon.com/images/I/71Z0rLIvpuL._SX466_.jpg",
    ...
    //   artist: "maroon 5",
    //   cover:
    //     "https://i.pinimg.com/originals/64/e4/c3/64e4c3c97cd3c84b8622e1550f2ddb68.jpg",
    ...
    //   cover:
    //     "https://m.media-amazon.com/images/M/MV5BNGRlODU0NzYtMmZkYi00ZmFiLTkyMDYtYmI0ZGYyNjFiNTI3XkEyXkFqcGdeQXVyMjA4OTI5NDQ@._V1_.jpg",
    ...
    //   artist: "AC/DC",
    //   cover:
    //     "https://i.ebayimg.com/00/s/MTQwMFgxNDAw/z/aK8AAOSwVHlez~hV/$_57.JPG",
    ...
    //   artist: "taylor swift",
    //   cover:
    //     "https://i.pinimg.com/originals/2c/ea/5c/2cea5c632449e73d692d8c1ff5cf31fa.jpg",
    ...
    //   artist: "blink 182",
    //   cover:
    //     "https://lastfm.freetls.fastly.net/i/u/ar0/22b76185df59649eea7c24a755742836.jpg",
    ...
    //   cover:
    //     "https://ih1.redbubble.net/image.1147067129.2914/gbrf,6x6,f,540x540-pad,450x450,f8f8f8.jpg",
    ...
    //   artist: "dragon force",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/thumb/8/80/DragonForce_Cry_Thunder_Single.jpg/220px-DragonForce_Cry_Thunder_Single.jpg",
    ...
    //   artist: "alan walker",
    //   cover:
    //     "https://at-cdn-s02.audiotool.com/2017/04/08/documents/alan_walker_-_faded_remix_the_m0uze_the_fox/1/cover256x256-316b72232d984228bcb867a8f4c3dfa0.jpg",
    ...
    //   artist: "linkin park",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/4/44/Given_Up_Linkin_Park.jpg",
    ...
    //   cover:
    //     "https://4.bp.blogspot.com/-okI0OGl6HKw/WWdkiNDcVaI/AAAAAAAAJAI/GFwuCSyZQuIhIqt7w2WXssdHyOFTUuyKQCLcBGAs/s1600/2072950.jpg",
    ...
    //   artist: "AC/DC",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/d/d3/Acdchardasarock.jpg",
    ...
    //   artist: "bryan adams",
    //   cover:
    //     "https://images.eil.com/large_image/BRYAN_ADAMS_HERE%2BI%2BAM-222624.jpg",
    ...
    //   artist: "blink 182",
    //   cover:
    //     "https://i.pinimg.com/originals/b6/0f/08/b60f0812567d50a9c9568b0173cb1304.jpg",
    ...
    //   artist: "jack black",
    //   cover:
    //     "https://images-na.ssl-images-amazon.com/images/I/910pWm3bdAL._SX355_.jpg",
    ...
    //   artist: "guns n' roses",
    //   cover:
    //     "https://images-na.ssl-images-amazon.com/images/I/71H60P5NNuL._AC_SL1280_.jpg",
    ...
    //   artist: "linkin park",
    //   cover:
    //     "https://images.genius.com/51289d4bbcaefb4328522d8198553532.1000x1000x1.jpg",
    ...
    //   artist: "maroon 5",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/3/3e/Maroon_5_Maps_cover.png",
    ...
    //   artist: "cradle of filth",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/0/0a/Nymphetamine_cover.jpg",
    ...
    //   cover:
    //     "https://cdns-images.dzcdn.net/images/cover/8fdceab1167b1af2f2a699db8ed246ac/350x350.jpg",
    ...
    //   artist: "bryan adams",
    //   cover:
    //     "https://i.pinimg.com/originals/56/86/48/56864823cdf03717bb3e5b415090b9bd.jpg",
    ...
    //   artist: "hoobastank",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/2/2d/Hoobastank_-_The_Reason_%28song%29.jpg",
    ...
    //   artist: "celine dion",
    //   cover: "https://m.media-amazon.com/images/I/81o-Lz53BTL._AC_SX450_.jpg",
    ...
    //   cover:
    //     "https://media.musicarts.com/is/image/MMGS7/L46113000000000-00-600x600.jpg",
    ...
    //   artist: "cradle of filth",
    //   cover:
    //     "https://e.snmc.io/i/600/s/2abea34c56612468943949cc3ad32f32/3210368/cradle-of-filth-death-of-love-Cover-Art.jpg",
    ...
    //   cover:
    //     "https://images-na.ssl-images-amazon.com/images/I/51yb%2Bc0EmyL._AC_UL600_SR600,600_.jpg",
    ...
    //   artist: "illenium",
    //   cover:
    //     "https://c-sf.smule.com/rs-s90/arr/82/41/6635b658-3c49-4e47-9593-e652295f37ad_512.jpg",
    ...
    //   artist: "blink 182",
    //   cover:
    //     "https://images-na.ssl-images-amazon.com/images/I/71IlJb2KIsL._SL1400_.jpg",
    ...
    //   artist: "metallica",
    //   cover:
    //     "https://i.pinimg.com/originals/6f/09/10/6f091090b5acca269e349f36fec02ef4.png",
    ...
    //   artist: "katy perry",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/d/da/Katy_Perry_-_Wide_Awake_single_cover.jpg",
    ...
    //   artist: "halsey",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/f/f1/Without_Me_%E2%80%93_Halsey.png",
    ...
    //   artist: "james blunt",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/thumb/6/66/You%27re_Beautiful.png/220px-You%27re_Beautiful.png",
    ...
    //   artist: "canberis",
    //   cover:
    //     "https://upload.wikimedia.org/wikipedia/en/thumb/1/16/The_Cranberries_-_Zombie.jpg/220px-The_Cranberries_-_Zombie.jpg",
